...
def matrot2aa(pose_matrot):
    ...
    quat = matrot2quat(homogen_matrot)
    aa = quat2aa(quat)
    return aa

def aa2matrot(angle_axis):
    ...
    hand_pose_matrot = rotation_matrix[:, :3, :3].contiguous()
    return hand_pose_matrot
...
def matrot2quat(rotation_matrix, eps=1e-6):
